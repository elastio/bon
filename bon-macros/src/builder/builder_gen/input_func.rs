...
pub(crate) struct FuncInputParams {
    #[darling(default = "default")]
    expose_positional_fn: ItemParams,

    #[darling(flatten)]
    base: BuilderParams,
}

/// Workaround for `clippy::manual_unwrap_or_default` lint triggered in the code
/// generated by `darling` proc macro.
///
/// TODO: create an issue in `darling` repo to fix this.
