...
impl BuilderGenCtx {
    ...
    fn builder_mod(&self) -> TokenStream2 {
        ...
        quote! {
            ...
            #vis_top mod #builder_mod_ident {
                ...
                impl< #(#named_members_pascal: ::bon::private::MemberState,)* > self::State
                for ( #(#named_members_pascal,)* )
                {
                ...
                mod members {
                    #(
                        ...
                        #vis_child_child struct #named_members_idents;
                    )*
                }
            }
        }
    ...
    fn finish_fn(&self) -> Result<TokenStream2> {
        ...
        Ok(quote! {
            ...
            #must_use
            #vis #asyncness #unsafety fn #finish_fn_ident(self, #(#finish_fn_params,)*) #output
            where
                #(#where_bounds,)*
            {
                #(#members_vars_decls)*
