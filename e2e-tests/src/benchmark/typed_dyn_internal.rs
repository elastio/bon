...
struct Builder<'a, State> {
    state: PhantomData<State>,
    builder: BuilderInner<'a>,
}

impl<'a, State> Builder<'a, State> {
    #[inline(always)]
    fn arg1(mut self, arg1: &'a str) -> Builder<'a, (State,)> {
        self.builder.arg1 = Some(arg1);
        Builder {
            state: PhantomData,
    ...
    #[inline(always)]
    fn arg2(mut self, arg2: u32) -> Builder<'a, (State,)> {
        self.builder.arg2 = Some(arg2);
        Builder {
            state: PhantomData,
            builder: self.builder,
        }
    ...
    #[inline(always)]
    fn arg3(mut self, arg3: bool) -> Builder<'a, (State,)> {
        self.builder.arg3 = Some(arg3);
        Builder {
            state: PhantomData,
            builder: self.builder,
        }
    ...
    #[inline(always)]
    fn maybe_arg4(mut self, arg4: Option<String>) -> Builder<'a, (State,)> {
        self.builder.arg4 = Some(arg4);
        Builder {
            state: PhantomData,
            builder: self.builder,
        }
    ...
    #[inline(always)]
    fn maybe_arg5(mut self, arg5: Option<u32>) -> Builder<'a, (State,)> {
        self.builder.arg5 = Some(arg5);
        Builder {
            state: PhantomData,
            builder: self.builder,
        }
    ...
    fn call(self) -> u32 {
        regular(
            unsafe { self.builder.arg1.unwrap_unchecked() },
            unsafe { self.builder.arg2.unwrap_unchecked() },
            unsafe { self.builder.arg3.unwrap_unchecked() },
            unsafe { self.builder.arg4.unwrap_unchecked() },
            unsafe { self.builder.arg5.unwrap_unchecked() },
        )
    }
}
