...
The `#[builder]` macro now [benefits](https://github.com/elastio/bon/blob/88529337e261e8ca11268b2d4759f9372d802e45/bon/src/private/mod.rs#L8-L32) from the [`#[diagnostic::on_unimplemented]`](https://doc.rust-lang.org/nightly/reference/attributes/diagnostics.html#the-diagnosticon_unimplemented-attribute) attribute. Now it can generate a readable compile error with additional context for debugging in the following cases:
...
type InitialState = (::bon::Unset<String>, ::bon::Unset<String>);
...
impl<State: BuilderState<Member1 = ::bon::Unset<String>>> Builder<State> {
...
```rust
let InitialState = (::bon::Unset<String>, ::bon::Unset<String>);
...
We are continuing to improve [`bon`] and add new features. It's still a young crate and there are a lot of things to implement, so stay tuned!
