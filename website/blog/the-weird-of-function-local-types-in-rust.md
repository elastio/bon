...
The real code generated by [`#[bon::builder]`](../docs/guide/overview) is a bit more complex, it uses typestate pattern to catch all potential developer errors at compile time 🐱.
