...
-   Add `#[builder(getter(...))]` attribute ([#222](https://github.com/elastio/bon/pull/222)) to define getters for already set members. See [Getters](https://bon-rs.com/guide/typestate-api/getters) guide for details ([#226](https://github.com/elastio/bon/pull/226)). Thanks [@lazkindness](https://github.com/lazkindness) for the contribution!
