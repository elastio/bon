...
fn smoke_fn() {
    #[builder]
    fn sut(
        #[builder(pos = start_fn)] starter_1: bool,
        #[builder(pos = start_fn, into)] starter_2: char,
        #[builder(pos = start_fn, into)] starter_3: Option<&'static str>,
        named: u32,
        #[builder(pos = finish_fn)] finisher_1: &'static str,
        #[builder(pos = finish_fn, into)] finisher_2: &'static str,
    ) -> (
        bool,
        char,
        Option<&'static str>,
